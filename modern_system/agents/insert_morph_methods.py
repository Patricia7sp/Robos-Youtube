...
def insert_methods():
    ...
    file_path = '/Users/patriciamenezes/anaconda3/Agents_Videos_Youtube/modern_system/agents/animation_generator.py'
    
    # Conteúdo dos métodos a serem inseridos
    methods_content = '''
...
'''
    ...
    # Localiza o ponto de inserção (antes do método generate_scene_transition)
    marker = '    def generate_scene_transition'
    ...
    # Insere os novos métodos antes do ponto de inserção
    new_content = content[:insert_position] + methods_content + content[insert_position:]
